...
export default function CarrouselIRP() {
  ...
  const slides = [
    ...
    { src: `${base}images/inkredplumes/shot08-768.jpg`, title: "08 Tableau de bord vendeur", caption: "Vue vendeur listant ses œuvres : statut de publication, date de mise à jour, métriques simples (ex. vues/wishlist si prévu) et actions rapides (éditer/supprimer). Cette page illustre le parcours producteur : retrouver, ajuster, enrichir son catalogue sans friction. L’enjeu est la lisibilité des informations et la réactivité des opérations CRUD." },
